        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (newState !== instance.messageHandler.get(guild, 'ACTIVIDED') && newState !== instance.messageHandler.get(guild, 'DEACTIVIDED')) {
                    ...
                    if (!(newState === instance.messageHandler.get(guild, 'ACTIVIDED'))) return [3 /*break*/, 2];
                    if (!isDisabled) {
