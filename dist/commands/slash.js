var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    ...
    return new (P || (P = Promise))(function (resolve, reject) {
        function fullfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fullfilled, rejected); }
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (args.length && args[0] === "delete") {
                            ...
                            if (useGuild) {
                                channel.send("Slash command with the ID \"" + targetCommand_1 + "\" has benn deleted from guild \"" + guild.id + "\"");
                            }
                            else {
                                channel.send("Slash command with the ID \"" + targetCommand_1 + "\" has been deleted. This may take up to 1 hour to been seen all servers using your bot.")
                            }
                            return [2 /*return*/];
                        }
