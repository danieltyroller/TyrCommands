...
module.exports = {
    aliases: ['erforderlicherollen', 'erforderlicherolle', 'requiredroles', 'requirerole', 'requireroles'],
    minArgs: 2,
    maxArgs: 2,
    cooldown: '2s',
    expectedArgs: '<Befehl Name> <"none" | getaggte Rolle | Rollen ID String>',
    requiredPermissions: ['ADMINISTRATOR'],
    description: 'Gibt an, welche Rolle jeder Befehl benötigt.',
