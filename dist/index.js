...
var TyrCommands = /** @class */ (function (_super) {
    __extends(TyrCommands, _super);
    function TyrCommands(client, options) {
        ...
        _this._displayName = "";
        _this._prefixes = {};
        _this._categories = new Map(); // <:Category Name:Emoji ID>
        ...
        _this._botOwner = [''];
        _this._testServers = [];
        _this._defaultLanguage = "deutsch";
        if (!client) {
        ...
        if (!partials ||
            ...
            if (showWarns) {
                console.warn("TyrCommands > It is encouraged to use both \"MESSAGE\" and \"REACTION\" partials when using TyrCommands due to it's help menu. More information can be found here: https://discord.js.org/#/docs/main/stable/topics/partials");
            }
        }
        if (showWarns && !commandsDir) {
            console.warn('TyrCommands > No commands folder specified. Using "commands"');
        }
    ...
    TyrCommands.prototype.setMongoPath = function (mongoPath) {
    ...
    Object.defineProperty(TyrCommands.prototype, "displayName", {
        get: function () {
    ...
    TyrCommands.prototype.setDisplayName = function (displayName) {
        this._displayName = displayName;
        return this;
    };
    Object.defineProperty(TyrCommands.prototype, "prefixes", {
        get: function () {
    ...
    Object.defineProperty(TyrCommands.prototype, "defaultPrefix", {
        get: function () {
    ...
    TyrCommands.prototype.setDefaultPrefix = function (defaultPrefix) {
        this._defaultPrefix = defaultPrefix;
        return this;
    };
    TyrCommands.prototype.getPrefix = function (guild) {
        return this._prefixes[guild ? guild.id : ""] || this._defaultPrefix;
    };
    TyrCommands.prototype.setPrefix = function (guild, prefix) {
        if (guild) {
            this._prefixes[guild.id] = prefix;
        }
        return this;
    };
    Object.defineProperty(TyrCommands.prototype, "categories", {
        get: function () {
    ...
    Object.defineProperty(TyrCommands.prototype, "hiddenCategories", {
        get: function () {
    ...
    Object.defineProperty(TyrCommands.prototype, "color", {
        get: function () {
            return this._color;
        },
        enumerable: false,
    ...
    TyrCommands.prototype.setColor = function (color) {
        this._color = color;
        return this;
    };
    TyrCommands.prototype.getEmoji = function (category) {
    ...
    TyrCommands.prototype.getCategory = function (emoji) {
        var result = "";
     ...
     */
    TyrCommands.prototype.setCategoryEmoji = function (category, emoji) {
        console.warn("TyrCommands > The setCategoryEmoji method is deprecated, please use setCategorySettings");
        this.setCategorySettings(category, emoji);
        return this;
    };
    TyrCommands.prototype.setCategorySettings = function (category, emoji) {
        if (typeof category == "string") {
            if (!emoji) {
                throw new Error("TyrCommands > An emoji is required for category \"" + category + "\"");
            }
            if (this.isEmojiUsed(emoji)) {
                console.warn("TyrCommands > The emoji \"" + emoji + "\" for category \"" + category + "\" is already used.");
            }
    ...
    TyrCommands.prototype.isEmojiUsed = function (emoji) {
        var isUsed = false;
    ...
    Object.defineProperty(TyrCommands.prototype, "commandHandler", {
        get: function () {
    ...
    Object.defineProperty(TyrCommands.prototype, "mongoConnection", {
        get: function () {
    ...
    TyrCommands.prototype.isDBConnected = function () {
        var connection = this.mongoConnection;
        return !!(connection && connection.readyState === 1);
    };
    TyrCommands.prototype.setTagPeople = function (tagPeople) {
        this._tagPeople = tagPeople;
        return this;
    };
    Object.defineProperty(TyrCommands.prototype, "tagPeople", {
        get: function () {
    ...
    Object.defineProperty(TyrCommands.prototype, "showWarns", {
        get: function () {
    ...
    Object.defineProperty(TyrCommands.prototype, "del", {
        get: function () {
            return this._del;
        },
        enumerable: false,
    ...
    Object.defineProperty(TyrCommands.prototype, "ignoreBots", {
        get: function () {
    ...
    Object.defineProperty(TyrCommands.prototype, "botOwner", {
        get: function () {
    ...
    TyrCommands.prototype.setBotOwner = function (botOwner) {
    ...
    Object.defineProperty(TyrCommands.prototype, "testServers", {
        get: function () {
    ...
    Object.defineProperty(TyrCommands.prototype, "defaultLanguage", {
        get: function () {
    ...
    TyrCommands.prototype.setDefaultLanguage = function (defaultLanguage) {
        this._defaultLanguage = defaultLanguage;
        return this;
    };
    Object.defineProperty(TyrCommands.prototype, "messageHandler", {
        get: function () {
    ...
    Object.defineProperty(TyrCommands.prototype, "slashCommands", {
        get: function () {
