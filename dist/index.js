...
class TyrCommands extends events_1.EventEmitter {
    ...
    async setUp(client, options) {
        ...
        let { commandsDir = '', commandDir = '', featuresDir = '', featureDir = '', messagesPath, mongoUri, showWarns = true, delErrMsgCooldown = -1, defaultLanguage = 'deutsch', ignoreBots = true, dbOptions, testServers, disabledDefaultCommands = [], typeScript = false, ephemeral = true, debug = false } = options || {};
        if (mongoUri) {
