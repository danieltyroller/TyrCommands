...
var Command = /** @class */ (function () {
    function Command(instance, client, names, callback, error, _a) {
        ...
        if (typeof syntaxError === 'string') {
            console.warn("TyrCommands > String syntax errors are deprecated. Please use an object instead to specify the language. See https://github.com/danieltyroller/TyrCommands#storing-custom-messages-and-translations");
            syntaxError = {
                english: syntaxError,
            };
        }
    ...
    Command.prototype.verifyCooldown = function (cooldown, type) {
        ...
        var moreInfo = ' For more information please see https://github.com/danieltyroller/TyrCommands#command-cooldowns';
