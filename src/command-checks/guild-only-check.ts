...
export = (guild: Guild | null, command: Command, instance: TyrCommands, reply: Function) => {
   ...
   if (!guild) {
      reply(instance.messageHandler.get(guild, 'GUILD_ONLY_COMMAND')).then((message: Message | null) => {
         if (!message) {
            return
         }
