...
const replyFromCheck = async (reply: string | MessageEmbed | MessageEmbed[], message: Message) => {
   if (!reply) {
...
export default class CommandHandler {
   ...
   constructor(instance: TyrCommands, client: Client, dir: string, disabledDefaultCommands: string[], typeScript = false) {
      this._client = client

      this.setUp(instance, client, dir, disabledDefaultCommands, typeScript)
   }

   private async setUp(instance: TyrCommands, client: Client, dir: string, disabledDefaultCommands: string[], typeScript = false) {
   ...
   public async registerCommand(instance: TyrCommands, client: Client, file: string, fileName: string, builtIn = false) {
